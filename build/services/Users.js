...
usersRouter.get('/online', function (req, res) {
    var onlineUsers = shared_1.default.onlineUsers;
...
usersRouter.get('/:id', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Users_1.default.findById(req.params.id)];
            case 1:
                user = _a.sent();
                if (!user) {
                    res.status(404).send();
...
usersRouter.delete("/:id", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Users_1.default.findByIdAndDelete(req.params.id)];
            case 1:
                deleted = _a.sent();
                if (!deleted) {
                    res.status(500).send();
